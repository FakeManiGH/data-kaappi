...
function SideNav() {
    ...
    return (
        ...
        >
            ...
            <div className='flex flex-col gap-1 w-full'>
                {navList && navList.map((item) => (
                    <Link 
                        href={item.path} 
                        key={item.id} 
                        className={`flex items-center text-sm font-light group gap-2 p-3 px-5 w-full hover:bg-primary hover:text-white transition-colors 
            ...
            <div className='flex flex-col gap-2 p-4 bg-contrast mt-auto mb-6'>
