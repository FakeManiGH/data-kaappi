  ...
  return (
    <>
      {files.map((file, index) => (
        <div key={index} className='flex items-center justify-between w-full mt-3 border border-contrast2 rounded-xl'>
          <div className='flex flex-1 items-center gap-2 p-2'>
            ...
            <div className='flex-col justify-center items-center w-full'>
              <div className='flex flex-wrap items-center gap-2'>
                ...
                <p className='text-xs text-gray-500 dark:text-gray-400'>{(file?.size / (1024 * 1024)).toFixed(2)} Mt</p>
              </div>
