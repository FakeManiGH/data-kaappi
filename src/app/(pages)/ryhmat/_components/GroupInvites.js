        ...
        <form className={`flex flex-col py-2 text-sm border-b border-contrast`} onSubmit={handleRequestApproval}>
            <div className='flex items-center gap-2 justify-between'>
                ...
                <button type='button' onClick={() => setOpen(!open)}>
                   {open ? <ChevronUpCircle className='text-red-500 hover:text-red-600' /> : <ChevronDownCircle className='text-primary hover:text-primary/75' />}
                </button>
            </div>
            ...
            <div className={`transition-all origin-top ${open ? 'scale-y-100 h-full' : 'scale-y-0 h-0'}`}>
                ...
                <div className='flex items-center gap-2 flex-wrap'>
                    ...
                    <input
                        ...
                        className='max-w-full py-2.5 px-3 bg-background text-sm border border-transparent outline-none focus:border-primary focus:ring-1'
                    />
                    <button
                        type='submit'
                        className='py-2 px-3 bg-primary text-white hover:bg-primary/75 rounded-full '
                    >
                        Hyväksy kutsu
                    </button>
                </div>
