                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex items-center gap-2 flex-nowrap'>
                        <input
                            ...
                            className='w-full py-2 px-3  bg-secondary text-sm border border-transparent outline-none focus:border-primary focus:ring-1'
                        />
                        <button
                            type='submit'
                            className='py-2 px-3 bg-primary text-white hover:bg-primary/75  whitespace-nowrap'
                        >
                            Hyväksy kutsu
                        </button>
                    </div>
