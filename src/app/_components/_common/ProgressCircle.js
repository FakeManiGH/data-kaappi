...
function ProgressCircle({ usedSpace, totalSpace }) {
    ...
    return (
        ...
        <div className="relative size-40">
            <svg className="rotate-[90deg] size-full" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                {/* Background circle */}
                <circle cx="18" cy="18" r="15" fill="none" className="stroke-current text-gray-200 dark:text-contrast2" strokeWidth="4" strokeDasharray="100"></circle>
                {/* Progress circle */}
            ...
            <div className="absolute top-1/2 start-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                <p className="text-2xl font-bold text-primary">{translateFileSize(usedSpace)}</p>
