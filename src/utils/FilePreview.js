...
export const getCardPreview = ({ file }) => {
    if (file.type.includes('image')) {
        ...
        return (
            <img src='/icons/audio.png' alt='Audio PNG illustration' style={{height: '100%', width: '100%', maxHeight: '125px', objectFit: 'contain'}} />
        );
    } else {
        return (
            <img src='/icons/file.png' alt='File PNG illustration' style={{height: '100%', width: '100%', maxHeight: '125px', objectFit: 'contain'}} />
        );
    }
}
    ...
    if (file.type.includes('image')) {
        ...
        return (
            <div className='flex flex-col gap-2 items-center'>
                ...
                <audio src={file.url} controls className="h-auto rounded-lg" />
            </div>
        );
    } else {
        return (
